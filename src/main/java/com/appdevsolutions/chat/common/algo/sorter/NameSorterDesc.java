...
public class NameSorterDesc<T> implements Comparator<T>
{
	@Override
	public int compare(T obj1,T obj2){
		if(obj1 instanceof AudioModel && obj2 instanceof AudioModel){
			...
			return object2.getName().toString().compareTo(object1.getName().toString());
			...
			return object2.getMessage().compareTo(object1.getMessage());
			...
			return object2.getEmailTemplateModel().getName().compareTo(object1.getEmailTemplateModel().getName());
