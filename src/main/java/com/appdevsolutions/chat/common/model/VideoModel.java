...
public final class VideoModel {
	...
	private final VideoType contentType;
	private final LocalDateTime createTimestamp;
	private final LocalDateTime updateTimestamp;
	public VideoModel(final String id,final String senderId,final String receiverId, final String name,final InputStream data, final long size, final VideoType contentType, final LocalDateTime createTimestamp, LocalDateTime updateTimestamp) {
		this.id=id;
	...
	public String toString() {
		return "VideoModel [id=" + id + ", senderId=" + senderId + ", receiverId=" + receiverId + ", name=" + name
