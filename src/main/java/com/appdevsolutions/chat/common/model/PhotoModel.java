...
public final class PhotoModel {
	...
	public PhotoModel(final String id,final String senderId,final String receiverId, final String name,final InputStream data, final long size, final ImageType contentType, final LocalDateTime createTimestamp, LocalDateTime updateTimestamp) {
		this.id=id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final PhotoModel other = (PhotoModel) obj;
	...
	public String toString() {
		return "PhotoModel [id=" + id + ", senderId=" + senderId + ", receiverId=" + receiverId + ", name=" + name
