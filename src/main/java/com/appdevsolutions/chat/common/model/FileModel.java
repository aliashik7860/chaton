...
public final class FileModel {
	...
	public FileModel(final String id,final String senderId,final String receiverId, final String name,final InputStream data, final long size, final FileType contentType, final LocalDateTime createTimestamp, LocalDateTime updateTimestamp) {
		this.id=id;
	...
	public String toString() {
		return "FileModel [id=" + id + ", senderId=" + senderId + ", receiverId=" + receiverId + ", name=" + name
