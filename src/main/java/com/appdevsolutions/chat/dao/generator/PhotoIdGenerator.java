...
public class PhotoIdGenerator implements IdentifierGenerator{
	private static final String PREFIX="PHOTO";
	private static final String PRIMARY_KEY_CONST="photoId";
	...
	private static final Logger LOGGER=LoggerFactory.getLogger(PhotoIdGenerator.class);
	...
	public Serializable generate(SessionImplementor sessionImplementor, Object object) throws HibernateException {
		...
		try {
			...
			if (!rs.next()) {
				...
				rs.close();
				code = PREFIX + StringUtils.leftPad("" + count,4, '0');
				LOGGER.info("newly generating photo id : "+code);
