...
public class EmailTemplateIdGenerator implements IdentifierGenerator{
	
	private static final String PREFIX="EMLTMPLT";
	...
	private static final Logger LOGGER=LoggerFactory.getLogger(EmailTemplateIdGenerator.class);
	...
	public Serializable generate(SessionImplementor sessionImplementor, Object object) throws HibernateException {
		...
		try {
			...
			selectStatement.setString(1, "emailTemplateId");
			...
			if (!rs.next()) {
				...
				insertStatement.setString(3, "emailTemplateId");
				...
				updateStatement.setString(2, "emailTemplateId");
