...
public class EmailNotificationTemplateIdGenerator implements IdentifierGenerator{

	private static final String PRIMARY_KEY_CONST="emailNotificationTemplateId";
	private static final String PREFIX="EMLNTMPLT";
	...
	private static final Logger LOGGER=LoggerFactory.getLogger(EmailNotificationTemplateIdGenerator.class);
	...
	public Serializable generate(SessionImplementor sessionImplementor, Object object) throws HibernateException {
		...
		try {
			...
			selectStatement.setString(1, PRIMARY_KEY_CONST);
			...
			if (!rs.next()) {
				...
				insertStatement.setString(3, PRIMARY_KEY_CONST);
				...
				updateStatement.setString(2, PRIMARY_KEY_CONST);
