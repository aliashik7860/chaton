...
import com.appdevsolutions.chat.web.rest.validation.UpdatePasswordModelJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class UpdatePasswordRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(UpdatePasswordRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
		...
		try{
			final Map<String,String> map=UpdatePasswordModelJsonValidator.validate(body);
			LOGGER.info("request updatePasswordModel: "+map);
			request.setAttribute(ChatOnWebConstants.UPDATE_PASSWORD_MAP,map);
			return true;
