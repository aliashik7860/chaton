...
import com.appdevsolutions.chat.web.rest.validation.MessagesModelJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class CreateMessageRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(CreateMessageRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
		...
		try{
			request.setAttribute(ChatOnWebConstants.MESSAGES_MODEL, MessagesModelJsonValidator.validate(body));
			return true;
