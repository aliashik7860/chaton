...
import com.appdevsolutions.chat.web.rest.validation.EmailNotificationTemplateMapByIdJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class CreateEmailNotificationTemplateByIdRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(CreateEmailNotificationTemplateByIdRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
		...
		try{
			request.setAttribute(ChatOnWebConstants.EMAIL_NOTIFICATION_TEMPLATE_MAP_BY_ID, EmailNotificationTemplateMapByIdJsonValidator.validate(body));
			return true;
