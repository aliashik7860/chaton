...
import com.appdevsolutions.chat.web.rest.validation.UpdateEmailTemplateBodyByIdJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class UpdateEmailTemplateBodyByIdRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(UpdateEmailTemplateBodyByIdRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
		...
		try{
			final Map<String, String> map=UpdateEmailTemplateBodyByIdJsonValidator.validate(body);
			LOGGER.info("request updateEmailTemplateBodyById: "+map);
			request.setAttribute(ChatOnWebConstants.UPDATE_EMAIL_TEMPLATE_BODY_BY_ID, map);
			return true;
