...
import com.appdevsolutions.chat.web.rest.validation.EmailNotificationTemplateMapBySubjectJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class CreateEmailNotificationTemplateBySubjectRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(CreateEmailNotificationTemplateBySubjectRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
		...
		try{
			request.setAttribute(ChatOnWebConstants.EMAIL_NOTIFICATION_TEMPLATE_MAP_BY_SUBJECT, EmailNotificationTemplateMapBySubjectJsonValidator.validate(body));
			return true;
