...
import com.appdevsolutions.chat.web.rest.validation.FriendShipModelJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class CreateFriendShipModelRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(CreateFriendShipModelRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
		...
		try{
			request.setAttribute(ChatOnWebConstants.FRIEND_SHIP_MODEL, FriendShipModelJsonValidator.validate(body));
			return true;
