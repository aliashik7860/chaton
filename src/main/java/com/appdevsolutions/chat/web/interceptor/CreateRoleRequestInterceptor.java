...
import com.appdevsolutions.chat.web.rest.validation.RoleModelJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class CreateRoleRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(CreateRoleRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
		...
		try{
			request.setAttribute(ChatOnWebConstants.ROLE_MODEL, RoleModelJsonValidator.validate(body));
			return true;
