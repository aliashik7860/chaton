...
import com.appdevsolutions.chat.web.rest.validation.ErrorCodeMapJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class CreateErrorCodeRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(CreateErrorCodeRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
		...
		try{
			request.setAttribute(ChatOnWebConstants.ERROR_CODE_MAP, ErrorCodeMapJsonValidator.validate(body));
			return true;
