...
import com.appdevsolutions.chat.web.rest.validation.UpdateEmailTemplateFromBySubjectJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class UpdateEmailTemplateFromBySubjectRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(UpdateEmailTemplateFromBySubjectRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
		...
		try{
			final Map<String, String> map=UpdateEmailTemplateFromBySubjectJsonValidator.validate(body);
			LOGGER.info("request updateEmailTemplateFromBySubject: "+map);
			request.setAttribute(ChatOnWebConstants.UPDATE_EMAIL_TEMPLATE_FROM_BY_SUBJECT, map);
			return true;
