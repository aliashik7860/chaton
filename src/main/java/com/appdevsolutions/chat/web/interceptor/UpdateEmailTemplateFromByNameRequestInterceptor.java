...
import com.appdevsolutions.chat.web.rest.validation.UpdateEmailTemplateFromByNameJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class UpdateEmailTemplateFromByNameRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(UpdateEmailTemplateFromByNameRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
		...
		try{
			final Map<String, String> map=UpdateEmailTemplateFromByNameJsonValidator.validate(body);
			LOGGER.info("request updateEmailTemplateFromByName: "+map);
			request.setAttribute(ChatOnWebConstants.UPDATE_EMAIL_TEMPLATE_FROM_BY_NAME, map);
			return true;
