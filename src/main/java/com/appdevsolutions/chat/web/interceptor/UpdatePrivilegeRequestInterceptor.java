...
import com.appdevsolutions.chat.web.rest.validation.UpdatePrivilegeModelJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class UpdatePrivilegeRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(UpdatePrivilegeRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
		...
		try{
			request.setAttribute(ChatOnWebConstants.UPDATE_PRIVILEGE_MAP, UpdatePrivilegeModelJsonValidator.validate(body));
			return true;
