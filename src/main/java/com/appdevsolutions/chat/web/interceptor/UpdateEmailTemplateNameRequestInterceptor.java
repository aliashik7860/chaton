...
import com.appdevsolutions.chat.web.rest.validation.UpdateEmailTemplateNameJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class UpdateEmailTemplateNameRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(UpdateEmailTemplateNameRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
		...
		try{
			final Map<String, String> map=UpdateEmailTemplateNameJsonValidator.validate(body);
			LOGGER.info("request updateEmailTemplateName: "+map);
			request.setAttribute(ChatOnWebConstants.UPDATE_EMAIL_TEMPLATE_NAME, map);
			return true;
