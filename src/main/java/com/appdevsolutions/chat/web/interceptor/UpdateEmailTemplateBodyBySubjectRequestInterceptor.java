...
import com.appdevsolutions.chat.web.rest.validation.UpdateEmailTemplateBodyBySubjectJsonValidator;
import com.appdevsolutions.chat.web.rest.validation.exception.ChatOnJsonParseException;

@Component
public class UpdateEmailTemplateBodyBySubjectRequestInterceptor implements HandlerInterceptor {

	private static final Logger LOGGER=LoggerFactory.getLogger(UpdateEmailTemplateBodyBySubjectRequestInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
		...
		try{
			final Map<String, String> map=UpdateEmailTemplateBodyBySubjectJsonValidator.validate(body);
			LOGGER.info("request updateEmailTemplateBodyBySubject: "+map);
			request.setAttribute(ChatOnWebConstants.UPDATE_EMAIL_TEMPLATE_BODY_BY_SUBJECT, map);
			return true;
